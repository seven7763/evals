...
To run evals, you will need to set up and specify your [OpenAI API key](https://platform.openai.com/account/api-keys). After you obtain an API key, specify it using the [`OPENAI_API_KEY` environment variable](https://platform.openai.com/docs/quickstart/step-2-setup-your-api-key). Please be aware of the [costs](https://openai.com/pricing) associated with using the API when running evals. Completion functions that wrap the OpenAI client also accept an optional `api_base` (OpenAI SDK `base_url`) so you can point evals at any OpenAI-compatible multi-model gateway — for example [DaoXE](https://daoxe.com?utm_source=github&utm_medium=organic&utm_campaign=openai-evals&utm_content=readme) at `https://api.daoxe.com/v1`. You can also run and create evals using [Weights & Biases](https://wandb.ai/wandb_fc/openai-evals/reports/OpenAI-Evals-Demo-Using-W-B-Prompts-to-Run-Evaluations--Vmlldzo0MTI4ODA3).
